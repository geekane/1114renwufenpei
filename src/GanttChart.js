...
const GanttChart = () => {
  ...
  useEffect(() => {
    if (containerRef.current && !instanceRef.current) {
      // Complex configuration provided by the user
      ...
      const records = [
        { id: 1, title: '项目任务 1', developer: '熊大', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/bear.jpg', start: '2024-07-24', end: '2024-07-26', progress: 31, priority: 'P0' },
        { id: 2, title: '项目任务 2', developer: '狼哥', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/wolf.jpg', start: '07/25/2024', end: '07/28/2024', progress: 60, priority: 'P0' },
        { id: 3, title: '项目任务 3', developer: '兔姐', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/rabbit.jpg', start: '2024-07-28', end: '2024-08-01', progress: 100, priority: 'P1' },
        { id: 1, title: '项目任务 4', developer: '猫弟', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/cat.jpg', start: '2024-07-31', end: '2024-08-03', progress: 31, priority: 'P0' },
        { id: 2, title: '项目任务 5', developer: '鸟哥', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/bird.jpeg', start: '2024-08-02', end: '2024-08-04', progress: 60, priority: 'P0' },
        { id: 3, title: '项目任务 6', developer: '花姐', avatar: 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/custom-render/flower.jpg', start: '2024-08-03', end: '2024-08-10', progress: 100, priority: 'P1' }
      ];
      ...
      const columns = [
        {
          ...
          customLayout: args => {
            ...
            const developer = new VTableGantt.VRender.Text({ text: taskRecord.developer, fontSize: 16, fontFamily: 'sans-serif', fill: barColors[args.row], fontWeight: 'bold', maxLineWidth: width - 120, boundsPadding: [10, 0, 0, 0], alignSelf: 'center' });
      ...
      const option = {
        ...
        taskBar: {
          ...
          customLayout: args => {
            ...
            const developer = new VTableGantt.VRender.Text({ text: taskRecord.developer, fontSize: 16, fontFamily: 'sans-serif', fill: 'white', fontWeight: 'bold', maxLineWidth: width - (width >= 120 ? 120 : 60), boundsPadding: [10, 0, 0, 0] });
        ...
        timelineHeader: {
          backgroundColor: '#f0f0fb', colWidth: 80,
          scales: [
            {
              unit: 'day', step: 1, format(date) { return date.dateIndex.toString(); },
              customLayout: args => {
        ...
        minDate: '2024-07-20',
        maxDate: '2024-08-15',
        markLine: [ { date: '2024-07-29', style: { lineWidth: 1, lineColor: 'blue', lineDash: [8, 4] } }, { date: '2024-08-17', style: { lineWidth: 2, lineColor: 'red', lineDash: [8, 4] } } ],
      ...
      instanceRef.current = new VTableGantt.Gantt(containerRef.current, option);
    }
